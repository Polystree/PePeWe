...
<footer>
    <div class="footer">
        <div class="logo-parent">
            ...
            <div class="footer-links">
                <div href="" class="account">Account</div>
            ...
            <div class="footer-links">
                ...
                <div class="save-rp9999-with-app-new-user-parent">
                    <div class="save-rp9999-with">
                        Save Rp9999 with App New User Only
                    </div>
                    <div class="qr-code-parent">
                        <img class="qr-code-icon" alt="" src="/assets/img/qr-code.png" />
                        <div class="store-parent">
                            <a href="market://details?id=com.miHoYo.GenshinImpact"><img class="googleplay-icon" alt=""
                                    src="/assets/img/download-playstore.png" /></a>
                            <a href="itms-apps://apps.apple.com/app/id1517783697"><img class="appstore-icon" alt=""
                                    src="/assets/img/download-appstore.png" /></a>
                        </div>
                    </div>
                </div>
    ...
    <div class="copyright-team-3">
        ©️ Copyright Team 3 2024. All right reserved
    </div>
</footer>