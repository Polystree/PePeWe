<?php
$stmt = $connect->prepare("SELECT productId, name, image_path, description, price, quantity, category, sold_count, view_count, created_at, updated_at, is_featured, status FROM products");
$stmt->execute();
