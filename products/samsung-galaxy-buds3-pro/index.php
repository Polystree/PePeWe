...
$product = [
    ...
    'price' => 3299000,
    'image_path' => '/assets/img/product/5982-galaxy-buds3-pro.avif',
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['add_review'])) {
        ...
        $productId = getProductId('Samsung Galaxy Buds3 Pro', $connect);
        $review = $_POST['review'];
...
<head>
    ...
    <title>Samsung Galaxy Buds3 Pro - Product Details - iniGadget</title>
            ...
            <div class='product-grid'>
                <div class='gallery-section'>
                    <div class='main-image'>
                        <img src='/assets/img/product/5982-galaxy-buds3-pro.avif' alt='Samsung Galaxy Buds3 Pro Main Image' id='mainImage'>
                    </div>
                </div>
