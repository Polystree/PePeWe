...
$product = [
    ...
    'price' => 15999000,
    'image_path' => '/assets/img/product/1733487418-google-pixel-8-pro.png',
    'description' => 'Advanced AI features, exceptional camera capabilities, and pure Android experience',
    'quantity' => 30
];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['add_review'])) {
        ...
        $productId = getProductId('Google Pixel 8 Pro', $connect);
        $review = $_POST['review'];
...
<head>
    ...
    <title>Google Pixel 8 Pro - Product Details - iniGadget</title>
...
<body>
            ...
            <div class='product-grid'>
                <div class='gallery-section'>
                    <div class='main-image'>
                        <img src='/assets/img/product/1733487418-google-pixel-8-pro.png' alt='Google Pixel 8 Pro Main Image' id='mainImage'>
                    </div>
                    <div class='thumbnail-grid'>
                        <div class='thumbnail active'>
                            <img src='/assets/img/product/1733487418-google-pixel-8-pro.png' alt='Google Pixel 8 Pro Thumbnail 1'>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function toggleEditForm(button) {
            ...
            button.textContent = form.classList.contains('show') ? 'Cancel' : 'Edit';
        }
    </script>
</body>
</html>