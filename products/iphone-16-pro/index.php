...
$product = [
    'name' => 'iPhone 16 Pro',
    'price' => 21999999,
    'image_path' => '/assets/img/product/7224-iphone-16-pro.webp',
    'description' => 'Apple A18 Pro, 120Hz LTPO Super Retina XDR OLED, iOS 18, upgradable to iOS 18.2',
    'quantity' => 99
];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['add_review'])) {
        ...
        $productId = getProductId('iPhone 16 Pro', $connect);
        $review = $_POST['review'];
...
<head>
    ...
    <title>iPhone 16 Pro - Product Details - iniGadget</title>
            ...
            <div class='product-grid'>
                <div class='gallery-section'>
                    <div class='main-image'>
                        <img src='/assets/img/product/7224-iphone-16-pro.webp' alt='iPhone 16 Pro Main Image' id='mainImage'>
                    </div>
                </div>
