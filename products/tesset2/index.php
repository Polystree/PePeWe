...
$product = [
    'name' => 'tesset2',
    'price' => 45325,
    'image_path' => '/assets/img/product/3784-tesset.jpg',
    'description' => 'esrser',
    'quantity' => 24
];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['add_review'])) {
        ...
        $productId = getProductId('tesset2', $connect);
        $review = $_POST['review'];
...
<head>
    ...
    <title>tesset2 - Product Details - iniGadget</title>
            ...
            <div class='product-grid'>
                <div class='gallery-section'>
                    <div class='main-image'>
                        <img src='/assets/img/product/3784-tesset.jpg' alt='tesset2 Main Image' id='mainImage'>
                    </div>
                </div>
