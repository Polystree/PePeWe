...
$product = [
    'name' => 'ROG Ally X',
    'price' => 13999000,
    'image_path' => '/assets/img/product/4017-rog-ally-x.jpg',
    'description' => 'Windows 11 Home (64-bit), AMD Ryzen™ Z1 Extreme, 7” FHD (1920 x 1080) 16:9 IPS Display, 12GB + 12GB LPDDR5, 1TB M.2 NVMe™ PCIe® 4.0 SSD',
    'quantity' => 18
];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['add_review'])) {
        ...
        $productId = getProductId('ROG Ally X', $connect);
        $review = $_POST['review'];
...
<head>
    ...
    <title>ROG Ally X - Product Details - iniGadget</title>
            ...
            <div class='product-grid'>
                <div class='gallery-section'>
                    <div class='main-image'>
                        <img src='/assets/img/product/4017-rog-ally-x.jpg' alt='ROG Ally X Main Image' id='mainImage'>
                    </div>
                </div>
