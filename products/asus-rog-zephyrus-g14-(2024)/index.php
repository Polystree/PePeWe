...
$product = [
    ...
    'price' => 30999000,
    'image_path' => '/assets/img/product/3191-asus-rog-zephyrus-g14-2024-.png',
    'description' => 'Windows 11 Home, AMD Ryzen™ 7 8845HS, NVIDIA® GeForce RTX™ 4050, 16GB LPDDR5X 6400 on board, 1TB PCIe® 4.0 NVMe™ M.2 SSD, 120Hz ROG Nebula Display 14-inch 3K (2880 x 1800) OLED 16:10 aspect ratio',
    'quantity' => 16
];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['add_review'])) {
        ...
        $productId = getProductId('ASUS ROG Zephyrus G14 (2024)', $connect);
        $review = $_POST['review'];
...
<head>
    ...
    <title>ASUS ROG Zephyrus G14 (2024) - Product Details - iniGadget</title>
            ...
            <div class='product-grid'>
                <div class='gallery-section'>
                    <div class='main-image'>
                        <img src='/assets/img/product/3191-asus-rog-zephyrus-g14-2024-.png' alt='ASUS ROG Zephyrus G14 (2024) Main Image' id='mainImage'>
                    </div>
                </div>
