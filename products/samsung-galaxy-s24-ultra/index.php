...
$product = [
    ...
    'price' => 18999000,
    'image_path' => '/assets/img/product/1733487293-samsung-galaxy-s24-ultra.jpg',
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['add_review'])) {
        ...
        $productId = getProductId('Samsung Galaxy S24 Ultra', $connect);
        $review = $_POST['review'];
...
<head>
    ...
    <title>Samsung Galaxy S24 Ultra - Product Details - iniGadget</title>
